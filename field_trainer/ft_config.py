...
AUDIO_DIR: str = os.getenv("FIELD_TRAINER_AUDIO_DIR", "/opt/field-trainer/audio")
AUDIO_CONFIG_PATH: str = os.getenv("FIELD_TRAINER_AUDIO_CONFIG", "/opt/field-trainer/config/audio_config.json")
